...
export const REPORT_NUTRITION_TOOL: Anthropic.Tool = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      calories: { type: "number", description: "Total energy in kcal (e.g., 320 for a medium meal)." },
      protein_g: { type: "number", description: "Protein in grams (e.g., 25 for a chicken breast)." },
      carbs_g: { type: "number", description: "Total carbohydrates in grams (e.g., 45 for a cup of rice)." },
      fat_g: { type: "number", description: "Total fat in grams (e.g., 12 for a tablespoon of olive oil)." },
      fiber_g: { type: "number", description: "Dietary fiber in grams (e.g., 3 for a medium apple)." },
      sodium_mg: { type: "number", description: "Sodium in milligrams (e.g., 600 for a typical restaurant meal)." },
      saturated_fat_g: {
        type: "number",
