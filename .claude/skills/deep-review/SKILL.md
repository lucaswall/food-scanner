...
4. **UI update** — Does the component handle all response shapes? All error types? Loading states?
5. **Edge cases** — Empty data, concurrent actions, stale cache, network failure, large payloads, back/forward navigation
