...
| **plan-review-implementation** | Opus (lead) / Sonnet (reviewers) | After plan-implement | Agent team QA review + post-PR bug-hunter review + CI monitor (squash-merge when CI is green) |
