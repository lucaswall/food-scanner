...
- Save for Later — analyze food now and log it when you actually eat it
- Quick Capture Session — take multiple photos in batch, then triage and log them all at once
- Hydration readings API for HealthHelper water intake sync

### Fixed

- Shared food links now show the log confirmation screen correctly after logging
- Food validation and matching consistency improvements
- Minor bug fixes from code audit
...
- External API endpoints for food history, common foods, food search, fasting windows, and earliest entry date — all with Bearer token auth and rate limiting
...
- Custom time picker replaced with select-based picker for full iOS Safari compatibility
...
- Food log calories now correctly rounded to whole numbers before saving

## [1.15.2] - 2026-02-20

### Fixed

- AI analysis now always combines all food items into a single log entry

## [1.15.1] - 2026-02-20

### Fixed

- Quick Select search now finds foods by name when keywords are missing

## [1.15.0] - 2026-02-20

### Added

- Swipe gestures to navigate between app sections
- Reordered bottom navigation with Chat as the primary tab

### Changed

- Streamlined dashboard layout with cleaner spacing and alignment

## [1.14.1] - 2026-02-19

### Fixed

- CSP form-action directive now allows Google and Fitbit OAuth domains
...
[1.15.0]: https://github.com/lucaswall/food-scanner/compare/v1.14.1...v1.15.0
[1.14.1]: https://github.com/lucaswall/food-scanner/compare/v1.14.0...v1.14.1
